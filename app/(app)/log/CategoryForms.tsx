...
export function TransportForm({
  ...
  const [subType, distanceKm, passengers] = useWatch({
    control,
    name: ['subType', 'distanceKm', 'passengers'],
  });
...
export function ShoppingForm({
  ...
  const [subType, quantity] = useWatch({
    control,
    name: ['subType', 'quantity'],
  });
