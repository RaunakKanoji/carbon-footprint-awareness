      ...
      {successMsg && (
        <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 text-emerald-800 dark:text-emerald-300 rounded-2xl flex items-center justify-between gap-3 text-sm font-medium animate-slide-in">
          ...
          <button
            ...
            className="p-1 rounded-full hover:bg-emerald-500/20 text-emerald-700 dark:text-emerald-400 transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-primary/25"
      ...
      {errorMsg && (
        <div className="p-4 bg-red-500/10 border border-red-500/20 text-red-800 dark:text-red-300 rounded-2xl flex items-center justify-between gap-3 text-sm font-medium animate-slide-in">
          ...
          <button
            ...
            className="p-1 rounded-full hover:bg-red-500/20 text-red-700 dark:text-red-400 transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-primary/25"
          ...
          <div className="bg-bg-surface border border-border-default rounded-2xl shadow-md overflow-hidden">
            ...
            <div className="p-6 pt-0 relative flex flex-col items-center text-center">
              ...
              <div className="mt-4 flex flex-wrap gap-2 justify-center">
                <span className="rounded-full border border-accent-primary/20 bg-accent-primary-dim px-2.5 py-0.5 text-xs font-semibold text-accent-primary">
                  Carbon Tracker
                </span>
                ...
                {completedChallenges.length > 0 && (
                  <span className="flex items-center gap-1 rounded-full border border-amber-500/20 bg-amber-500/10 px-2.5 py-0.5 text-xs font-semibold text-amber-600">
              ...
              <button
                ...
                className="mt-6 flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl border border-border-default bg-bg-base px-4 py-2 text-xs font-bold text-text-primary transition-colors hover:bg-bg-elevated focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-primary/25"
              >
          ...
          <div className="bg-bg-surface border border-border-default rounded-2xl shadow-md overflow-hidden flex flex-col h-full">
            ...
            <div className="flex border-b border-border-default bg-bg-base/40">
              <button
                ...
                className={`flex-1 py-4 text-sm font-semibold border-b-2 transition-colors flex items-center justify-center gap-2 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-primary/25 ${
                  activeTab === 'general'
              ...
              <div className="p-6 flex-1 space-y-6">
                  ...
                  <div className="space-y-6 animate-fade-in">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      ...
                      <div className="space-y-2">
                        ...
                        <select {...register('commuteMode')} className={selectFieldClassName}>
                  ...
                  <div className="space-y-6 animate-fade-in">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      ...
                      <div className="space-y-2">
                        ...
                        <select {...register('dietType')} className={selectFieldClassName}>
                ...
                {activeTab === 'achievements' && (
                  <div className="space-y-6 animate-fade-in">
                    ...
                    {(() => {
                      const points =
                        100 + completedChallenges.reduce((sum, c) => sum + c.points, 0);
                      const level = Math.floor(points / 500) + 1;
                      const currentLevelProgress = points % 500;
                      const pointsToNextLevel = 500 - currentLevelProgress;
                      const progressPercent = Math.round((currentLevelProgress / 500) * 100);
                      ...
                      return (
                        <div className="bg-bg-base border border-border-default rounded-xl p-5 space-y-4 shadow-xs">
                          <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-3">
                            <div className="flex items-center gap-3">
                              <div className="h-12 w-12 rounded-full bg-emerald-500/10 text-emerald-500 flex items-center justify-center border border-emerald-500/20 shrink-0">
                                <Icons.Award className="w-6 h-6 text-emerald-600 dark:text-emerald-400" />
                              </div>
                              <div>
                                <h5 className="font-extrabold text-sm text-text-primary">
                          ...
                          <div className="space-y-1.5">
                            <div className="flex justify-between text-xs font-semibold">
                              ...
                              <span className="text-text-primary">
                                {currentLevelProgress} / 500 XP ({progressPercent}%)
                              </span>
                            </div>
                  ...
                  <div className="flex gap-2.5">
                    {isDirty && (
                      <button
                        ...
                        className="cursor-pointer rounded-xl border border-border-default px-4 py-2 text-xs font-semibold text-text-primary transition-colors hover:bg-bg-elevated focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-primary/25"
                      >
                        Discard
                      </button>
                    )}
                    ...
                    <button
                      ...
                      className="flex cursor-pointer items-center gap-1.5 rounded-xl bg-accent-primary px-5 py-2 text-xs font-bold text-white transition-colors hover:bg-accent-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-primary/25 disabled:cursor-not-allowed disabled:opacity-50"
                    >
                      {isSubmitting ? (
                        <>
